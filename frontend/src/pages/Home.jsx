        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-semibold text-yellow-600">{stats.inProgressTasks}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-semibold text-red-600">{stats.pendingTasks}</p>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-sm font-medium text-gray-600">Application Mobile</span>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          <div className="space-y-4">
            {[
              { user: 'Jean Dupont', action: 'a terminé la tâche', task: 'Refonte du site web', time: 'Il y a 2 heures' },
              { user: 'Marie Martin', action: 'a créé une nouvelle tâche', task: 'Mise à jour de la documentation', time: 'Il y a 3 heures' },
              { user: 'Pierre Durand', action: 'a commenté sur', task: 'Tests d\'intégration', time: 'Il y a 5 heures' }
            ].map((activity, index) => (
